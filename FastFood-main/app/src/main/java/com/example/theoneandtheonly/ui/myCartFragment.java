package com.example.theoneandtheonly.ui;
...
import com.example.theoneandtheonly.adapters.CartAdapter;
import com.example.theoneandtheonly.models.CartModel;
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                for (QueryDocumentSnapshot document : task.getResult()) {
                                    ...
                                    list.add(new CartModel(R.drawable.pizza1,document.getData().get("name").toString(),document.getData().get("prix").toString(),"4.0"));
